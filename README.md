...
├── data_source.md                # Link to data.ny.gov source
...
3. Download the dataset from [data.ny.gov](https://data.ny.gov/Government-Finance/Assembled-Workers-Compensation-Claims-Beginning-20/jshw-gkgu/about_data) and save it locally
4. Run `01_wc_data_cleaning.ipynb` first, then `02_wc_eda.ipynb`
